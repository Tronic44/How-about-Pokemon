...
public class PokemonDraft {
	 ...
	 * @throws MyException wenn die Länge nicht übereinstimmt
	 */
	public static void setTierlist(char[] a) throws MyException {
		if (a.length != tierlist.length) {
